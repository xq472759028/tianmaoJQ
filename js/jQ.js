// $(document).ready(function () {
    window.onload=function () {
        ...
        var lunbo = $('.lunbo');
        bannerlist.each(function (number, t) {
            $(t).mouseover(function () {
                    $(lunbo[number]).addClass('active');
                }
            )
            $(t).mouseout(function () {
                    $(lunbo[number]).removeClass('active');
                }
            )
        });
...
//创建一个Show函数
        function Show() {
            ...
            $('.yuan').eq(i).addClass('background', 'red').siblings('.yuan').removeClass('background', 'red');
